...
def period_calculator(period):
    ...
    for i in period:
        ...
        if i.lower() == 'y':
            ...
            years = int(years) * 31536000
            temp = ''
        elif i.lower() == 'm':
            months = temp.split('m')
            months = months[0][0:len(months[0])]
            months = int(months) * 2628288
            temp = ''
        elif i.lower() == 'd':
            days = temp.split('d')
...
def main():
    ...
    print(f'Speed in percentage of speed of light: {round(ending_speed / 299792458,4)}%')
    print(f'{round((ending_speed / 299792458)/100,2)} times the speed of light\n')
